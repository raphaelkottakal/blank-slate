			...
			<div>
				...
				<div className="group">
					...
					<div style={_.assignIn({}, css.textHalf, {paddingLeft: 8})}>
						...
						<a style={css.shop} href="http://www.myntra.com/men-jeans-store?f=Fit_article_attr%3Askinny%2520fit%2Csuper%2520skinny%2520fit" target="_blank">Shop now</a>
					</div>
				</div>
				...
				<div className="group">
					<div style={_.assignIn({},css.textHalf,{textAlign: 'right', paddingRight: 8})}>
						...
						<a style={css.shop} href="http://www.myntra.com/men-jeans-store?f=Fit_article_attr%3Aslim%2520fit%2Ctapered" target="_blank">Shop now</a>
					</div>
					<div style={css.imageHalf}>
						<GifSlider 
							imgs = {imgs.slim}
				...
				<div className="group">
					...
					<div style={_.assignIn({}, css.textHalf, {paddingLeft: 8})}>
						...
						<a style={css.shop} href="http://www.myntra.com/men-jeans-store?f=Fit_article_attr%3Aregular%2520fit" target="_blank">Shop now</a>
					</div>
				</div>
